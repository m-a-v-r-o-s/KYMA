...
export const AREA = [
  {
    ...
    imgAltEn: "Kolymbithres beach on Paros: sculpted granite rock formations meeting shallow turquoise water",
    imgAltEl: "Παραλία Κολυμπήθρες στην Πάρο: γλυπτοί βράχοι γρανίτη δίπλα σε ρηχά τιρκουάζ νερά",
  },
  {
    ...
    imgAltEn: "Naoussa fishing harbour on Paros, lined with whitewashed tavernas",
    imgAltEl: "Το ψαρολίμανο της Νάουσας στην Πάρο, με λευκές ταβέρνες στην προκυμαία",
  },
  {
    ...
    imgAltEn: "Parikia waterfront, the capital and ferry port of Paros",
    imgAltEl: "Η παραλιακή Παροικία, πρωτεύουσα και λιμάνι της Πάρου",
  },
];
...
export const EXPERIENCES = [
  {
    ...
    imgAltEn: "A private motor yacht cruising on the turquoise sea off Paros",
    imgAltEl: "Ιδιωτικό σκάφος πλέει στα τιρκουάζ νερά της Πάρου",
    price: 600,
    unitEn: "day",
    unitEl: "ημέρα",
  },
  {
    ...
    imgAltEn: "The deck of a sailboat at sea during a sunset sailing trip",
    imgAltEl: "Το κατάστρωμα ιστιοπλοϊκού σκάφους στη θάλασσα κατά το ηλιοβασίλεμα",
    price: 90,
    unitEn: "person",
    unitEl: "άτομο",
  },
  {
    ...
    imgAltEn: "An off-road ATV quad bike on a dirt track on Paros",
    imgAltEl: "Όχημα ATV σε χωματόδρομο στην Πάρο",
    price: 45,
    unitEn: "day",
    unitEl: "ημέρα",
  },
  {
    ...
    imgAltEn: "A windsurfer riding a wave off Paros",
    imgAltEl: "Θαλάσσιο σπορ, ιστιοσανίδα σε κύμα στην Πάρο",
    price: 40,
    unitEn: "hour",
    unitEl: "ώρα",
  },
  {
    ...
    imgAltEn: "A scuba diver exploring a reef in the Aegean Sea",
    imgAltEl: "Δύτης εξερευνά ύφαλο στο Αιγαίο",
    price: 70,
    unitEn: "person",
    unitEl: "άτομο",
  },
  {
    ...
    imgAltEn: "Friends toasting with wine glasses during a local wine tasting",
    imgAltEl: "Φίλοι τσουγκρίζουν ποτήρια κρασιού σε τοπική γευσιγνωσία",
    price: 55,
    unitEn: "person",
    unitEl: "άτομο",
  },
...
export const t: Dict = {
  ...
  cal_loading: { en: "Checking availability…", el: "Έλεγχος διαθεσιμότητας…" },
  ...
  f_invalid_email: { en: "Please enter a valid email address.", el: "Παρακαλώ εισάγετε έγκυρο email." },
  f_invalid_phone: { en: "Please enter a valid phone number.", el: "Παρακαλώ εισάγετε έγκυρο τηλέφωνο." },
  ...
  footer_terms: { en: "Terms of Service", el: "Όροι Χρήσης" },
  footer_demo: {
  ...
  cookie_privacy_link: { en: "Read our Privacy Policy", el: "Δείτε την Πολιτική Απορρήτου" },
};
